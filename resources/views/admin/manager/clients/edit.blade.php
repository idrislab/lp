        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form id="clients-form" class="form-horizontal form-label-left"
                      method="post"
                      action="{{ route('manager.clients.edit', [ 'id' => $client->id ]) }}">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password-confirmation">Confirmar
                            Palavra-Passe *
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button class="btn btn-primary" type="button" id="cancel"
                                    data-href="{{ route('manager.clients') }}">Cancelar
                            </button>
